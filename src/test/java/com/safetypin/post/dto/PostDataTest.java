...
class PostDataTest {
    ...
    void testFromPostAndUserId_WithProfilesButNoMatch() {
        ...
        Map<UUID, PostedByData> profiles = new HashMap<>();
        profiles.put(differentUserId, PostedByData.builder()
        ...
        // When
        PostData result = PostData.fromPostAndUserId(mockPost, userId, profiles.get(mockPost.getPostedBy()));
    ...
    void testFromPostAndUserId_WithMatchingProfile() {
        ...
        // When
        PostData result = PostData.fromPostAndUserId(mockPost, userId, postedByData);
